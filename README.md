...
- `OpenSynapse-1.3.4-win-Setup.exe` installs for the current user and supports automatic updates.
- `OpenSynapse-1.3.4-win-Portable.zip` runs without installation.
