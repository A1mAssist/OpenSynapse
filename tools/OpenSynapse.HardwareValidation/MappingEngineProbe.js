...
const events = [];
const logPath = process.env.OPENSYNAPSE_MAPPING_LOG || 'D:/Workspaces/OpenSynapse/artifacts/protocol/2026-08-15/mapping-engine-input-01.jsonl';
...
(async () => {
  try {
    ...
    await delay(1000);
    const storageLog = 'C:/Users/A1mAssist/AppData/Local/Razer/RazerAppEngine/User Data/Logs/products_710_ui {00000000-0000-0000-FFFF-FFFFFFFFFFFF}4.log';
